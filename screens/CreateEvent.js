...
export default function CreateEvent() {
  ...
  const handleSubmit = async () => {
    try {
      const token = await AsyncStorage.getItem('userToken'); // Certifique-se de usar a chave correta para recuperar o token
      ...
      const response = await axios.post(`http://${ip}:3000/events/create`, formData, {
        headers: {
